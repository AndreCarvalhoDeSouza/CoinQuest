...
from src.Const import COLOR_BRONZE, COLOR_BLACK, WIN_WIDTH, MENU_OPTION
...
class Menu:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(100, "COIN", COLOR_BRONZE, ((WIN_WIDTH/2), 70))
            self.menu_text(100, "QUEST", COLOR_BRONZE, ((WIN_WIDTH / 2), 140))
